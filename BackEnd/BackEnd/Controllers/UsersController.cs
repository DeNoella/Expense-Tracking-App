...
namespace BackEnd.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateUserRequest request, CancellationToken cancellationToken)
        {
            ...
            {
                // Validate permissions exist in PermissionConstants
        ...
        public async Task<IActionResult> DeleteAllUsers(CancellationToken cancellationToken)
        {
            ...
            // Permissions and refresh tokens are now stored in Users table, so no need to delete separately
    ...
    public class UpdateUserRequest
    {
        ...
        public IEnumerable<string>? Permissions { get; set; } // Optional: update permissions when editing user
    }
}
