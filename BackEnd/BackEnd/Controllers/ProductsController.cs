    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] ProductCategory? category, [FromQuery] int? categoryId, [FromQuery] string? search, CancellationToken cancellationToken)
        {
            try
            {
                ...
                // Support both category (enum) and categoryId (int) for backward compatibility
                ...
                // Then load images separately to avoid issues with filtered Include
                ...
                foreach (var product in products)
                {
                    ...
                    // If no primary image found but ImageUrl exists, keep it
                    // This handles cases where ImageUrl was set directly
                }
        ...
        {
            // Determine category from Category or CategoryId
