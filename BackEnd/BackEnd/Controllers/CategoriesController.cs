...
namespace BackEnd.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        // Categories are now enums, so create/update/delete are not applicable
        // These endpoints are kept for backward compatibility but return appropriate responses
        [HttpPost]
